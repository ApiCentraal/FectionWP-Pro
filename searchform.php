...
<form role="search" method="get" class="search-form" action="<?php echo esc_url(home_url('/')); ?>">
    <label for="<?php echo esc_attr($unique_id); ?>" class="screen-reader-text">
        <?php esc_html_e('Zoeken naar:', 'fectionwp-pro'); ?>
    </label>
    <div class="input-group">
        <input 
            ...
            placeholder="<?php esc_attr_e('Zoeken...', 'fectionwp-pro'); ?>" 
            value="<?php echo get_search_query(); ?>" 
            name="s" 
            required
        />
        <button type="submit" class="btn btn-primary search-submit">
            <span class="screen-reader-text"><?php esc_html_e('Zoeken', 'fectionwp-pro'); ?></span>
