 ...
 */
class FWP_Recent_Posts_Widget extends WP_Widget {
    ...
    public function __construct() {
        parent::__construct(
            'fwp_recent_posts_widget',
            __('Recente Berichten (met afbeelding)', 'fectionwp-pro'),
            array(
                'description' => __('Toont recente berichten met thumbnails.', 'fectionwp-pro'),
                'classname'   => 'fwp-recent-posts-widget',
            )
        );
    }
    ...
    public function widget($args, $instance) {
        $title         = !empty($instance['title']) ? apply_filters('widget_title', $instance['title']) : __('Recente Berichten', 'fectionwp-pro');
        ...
        echo '<div class="fwp-recent-posts-list">';

        while ($recent_posts->have_posts()) {
            $recent_posts->the_post();
            ?>
            <article class="fwp-recent-post d-flex gap-3 mb-3 pb-3 border-bottom">
                <?php if ($show_thumb && has_post_thumbnail()) : ?>
                    <div class="fwp-recent-post-thumb flex-shrink-0">
                ...
                <div class="fwp-recent-post-content">
                    <h6 class="fwp-recent-post-title mb-1">
                    ...
                    <?php if ($show_excerpt) : ?>
                        <p class="fwp-recent-post-excerpt small text-muted mb-0">
    ...
    public function form($instance) {
        $title          = !empty($instance['title']) ? $instance['title'] : __('Recente Berichten', 'fectionwp-pro');
        $number         = !empty($instance['number']) ? absint($instance['number']) : 5;
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('title')); ?>">
                <?php esc_html_e('Titel:', 'fectionwp-pro'); ?>
            </label>
            <input 
                class="widefat" 
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('number')); ?>">
                <?php esc_html_e('Aantal berichten:', 'fectionwp-pro'); ?>
            </label>
            <input 
                class="tiny-text" 
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('category')); ?>">
                <?php esc_html_e('Categorie:', 'fectionwp-pro'); ?>
            </label>
            <?php
            wp_dropdown_categories(array(
                'show_option_all' => __('Alle categorieën', 'fectionwp-pro'),
                'class'           => 'widefat',
        ...
        <p>
            ...
            <label for="<?php echo esc_attr($this->get_field_id('show_thumb')); ?>">
                <?php esc_html_e('Toon thumbnails', 'fectionwp-pro'); ?>
            </label>
        </p>
        ...
        <p>
            ...
            <label for="<?php echo esc_attr($this->get_field_id('show_date')); ?>">
                <?php esc_html_e('Toon datum', 'fectionwp-pro'); ?>
            </label>
        </p>
        ...
        <p>
            ...
            <label for="<?php echo esc_attr($this->get_field_id('show_excerpt')); ?>">
                <?php esc_html_e('Toon excerpt', 'fectionwp-pro'); ?>
            </label>
        </p>

        <p>
            <label for="<?php echo esc_attr($this->get_field_id('excerpt_length')); ?>">
                <?php esc_html_e('Excerpt lengte (woorden):', 'fectionwp-pro'); ?>
            </label>
            <input 
                class="tiny-text" 
