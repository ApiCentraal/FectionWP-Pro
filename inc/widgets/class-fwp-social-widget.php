 ...
 */
class FWP_Social_Widget extends WP_Widget {
    ...
    public function __construct() {
        parent::__construct(
            'fwp_social_widget',
            __('Social Links', 'fectionwp-pro'),
            array(
                'description' => __('Toont social media iconen met links.', 'fectionwp-pro'),
                'classname'   => 'fwp-social-widget',
            )
        );
    }
    ...
    public function widget($args, $instance) {
        ...
        // Container
        $container_class = 'fwp-social-links d-flex flex-wrap gap-2';
        if ($style === 'buttons') {
    ...
    public function form($instance) {
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('icon_style')); ?>">
                <?php esc_html_e('Icoon bibliotheek:', 'fectionwp-pro'); ?>
            </label>
            <select 
                class="widefat" 
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('style')); ?>">
                <?php esc_html_e('Weergave stijl:', 'fectionwp-pro'); ?>
            </label>
            <select 
                class="widefat" 
            ...
            >
                <option value="icons" <?php selected($style, 'icons'); ?>><?php esc_html_e('Alleen iconen', 'fectionwp-pro'); ?></option>
                <option value="buttons" <?php selected($style, 'buttons'); ?>><?php esc_html_e('Buttons', 'fectionwp-pro'); ?></option>
            </select>
        </p>

        <p>
            <label for="<?php echo esc_attr($this->get_field_id('size')); ?>">
                <?php esc_html_e('Grootte:', 'fectionwp-pro'); ?>
            </label>
            <select 
                class="widefat" 
            ...
            >
                <option value="small" <?php selected($size, 'small'); ?>><?php esc_html_e('Klein', 'fectionwp-pro'); ?></option>
                <option value="normal" <?php selected($size, 'normal'); ?>><?php esc_html_e('Normaal', 'fectionwp-pro'); ?></option>
                <option value="large" <?php selected($size, 'large'); ?>><?php esc_html_e('Groot', 'fectionwp-pro'); ?></option>
            </select>
        </p>
        ...
        <p>
            ...
            <label for="<?php echo esc_attr($this->get_field_id('new_tab')); ?>">
                <?php esc_html_e('Open links in nieuw tabblad', 'fectionwp-pro'); ?>
            </label>
        </p>

        <hr />
        <p><strong><?php esc_html_e('Social Media URLs:', 'fectionwp-pro'); ?></strong></p>
