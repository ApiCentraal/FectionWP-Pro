    ...
    <div class="<?php echo esc_attr($content_class); ?> <?php echo $sidebar_position === 'left' ? 'order-md-2' : ''; ?>">
        <header class="page-header mb-4">
            <h1 class="page-title">
                <?php
                printf(
                    esc_html__('Zoekresultaten voor: %s', 'fectionwp-pro'),
        ...
        <?php if (have_posts()) : ?>
            ...
            <!-- Paginatie -->
            <nav class="posts-navigation mt-4" aria-label="<?php esc_attr_e('Zoekresultaten navigatie', 'fectionwp-pro'); ?>">
                <?php
                echo paginate_links(array(
                    'prev_text' => __('&laquo; Vorige', 'fectionwp-pro'),
                    'next_text' => __('Volgende &raquo;', 'fectionwp-pro'),
                ));
                ?>
            </nav>
        ...
        <?php else : ?>
            ...
            <div class="alert alert-info">
                <p class="mb-3"><?php esc_html_e('Geen resultaten gevonden. Probeer een andere zoekterm.', 'fectionwp-pro'); ?></p>
                <?php get_search_form(); ?>
            </div>
