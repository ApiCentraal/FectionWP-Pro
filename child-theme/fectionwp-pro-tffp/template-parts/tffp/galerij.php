...
">
  ...
  <div class="container position-relative">
    <div class="text-center mb-4 mb-lg-5">
      <span class="badge rounded-pill bg-primary-subtle text-primary border border-primary-subtle px-3 py-2 mb-3">Galerij</span>
      ...
      <div class="tffp-gallery-filters mb-4 mb-lg-5">
        <div class="d-flex flex-wrap justify-content-center gap-2" data-filter-group="category">
          <?php foreach ( $categories as $cat ) : ?>
            <button type="button" class="btn btn-sm btn-outline-primary rounded-pill" data-filter-value="<?php echo esc_attr( $cat ); ?>" aria-pressed="false">
        ...
        <div class="d-flex flex-wrap justify-content-center gap-2 mt-3 align-items-center" data-filter-group="customer">
          ...
          <?php foreach ( $customer_types as $type ) : ?>
            <button type="button" class="btn btn-sm btn-outline-secondary rounded-pill" data-filter-value="<?php echo esc_attr( $type ); ?>" aria-pressed="false">
              <?php
              if ( 'Kinderen' === $type ) {
        ...
        <div class="tffp-gallery-modal__dialog" role="document">
          ...
          <div class="tffp-gallery-modal__stage" data-modal-stage>
            ...
            <div class="tffp-gallery-modal__meta">
              ...
              <span class="badge rounded-pill bg-dark bg-opacity-25 border border-light border-opacity-25" data-modal-badge></span>
            </div>
