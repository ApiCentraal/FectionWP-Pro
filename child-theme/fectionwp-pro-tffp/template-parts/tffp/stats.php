...
?>
<section class="tffp-stats py-5 py-md-6">
  <div class="container-fluid py-4 px-3 px-md-5">
    <div class="text-center mb-5">
      <h2 class="display-6 fw-bold mb-3">Onze <span class="text-primary">Cijfers</span> Spreken</h2>
      <p class="text-body-secondary mb-0">
        Jarenlange ervaring en duizenden tevreden gezichten – dat is waar we trots op zijn
      </p>
    </div>
      ...
      <div class="col">
        <div class="card h-100 shadow-sm bg-white bg-opacity-75">
          <div class="card-body text-center p-4">
            ...
            <div class="fw-semibold">Blije Klanten</div>
            <div class="small text-body-secondary">Kinderen en volwassenen geschminkt</div>
          </div>
        </div>
      </div>
      ...
      <div class="col">
        <div class="card h-100 shadow-sm bg-white bg-opacity-75">
          <div class="card-body text-center p-4">
            ...
            <div class="fw-semibold">Evenementen</div>
            <div class="small text-body-secondary">Feestjes en festivals verzorgd</div>
          </div>
        </div>
      </div>
      ...
      <div class="col">
        <div class="card h-100 shadow-sm bg-white bg-opacity-75">
          <div class="card-body text-center p-4">
            ...
            <div class="fw-semibold">Locaties</div>
            <div class="small text-body-secondary">Door heel Nederland actief</div>
          </div>
        </div>
      </div>
    </div>
